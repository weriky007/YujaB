...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Helpers.Ads.AdsFacebook+NativeAdListener+MediaViewListener, PlayTube", AdsFacebook_NativeAdListener_MediaViewListener.class, __md_methods);
	}
	...
	public AdsFacebook_NativeAdListener_MediaViewListener ()
	{
		...
		if (getClass () == AdsFacebook_NativeAdListener_MediaViewListener.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Ads.AdsFacebook+NativeAdListener+MediaViewListener, PlayTube", "", this, new java.lang.Object[] {  });
	}
