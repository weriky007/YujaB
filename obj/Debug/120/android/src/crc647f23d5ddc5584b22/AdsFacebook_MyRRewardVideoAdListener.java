...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Helpers.Ads.AdsFacebook+MyRRewardVideoAdListener, PlayTube", AdsFacebook_MyRRewardVideoAdListener.class, __md_methods);
	}
	...
	public AdsFacebook_MyRRewardVideoAdListener ()
	{
		...
		if (getClass () == AdsFacebook_MyRRewardVideoAdListener.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Ads.AdsFacebook+MyRRewardVideoAdListener, PlayTube", "", this, new java.lang.Object[] {  });
	}
	...
	public AdsFacebook_MyRRewardVideoAdListener (android.app.Activity p0, com.facebook.ads.RewardedVideoAd p1)
	{
		super ();
		if (getClass () == AdsFacebook_MyRRewardVideoAdListener.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Ads.AdsFacebook+MyRRewardVideoAdListener, PlayTube", "Android.App.Activity, Mono.Android:Xamarin.Facebook.Ads.RewardedVideoAd, Xamarin.Facebook.AudienceNetwork.Android", this, new java.lang.Object[] { p0, p1 });
	}
