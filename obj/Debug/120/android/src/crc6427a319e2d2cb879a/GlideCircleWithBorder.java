...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Helpers.CacheLoaders.GlideCircleWithBorder, PlayTube", GlideCircleWithBorder.class, __md_methods);
	}
	...
	public GlideCircleWithBorder ()
	{
		...
		if (getClass () == GlideCircleWithBorder.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.CacheLoaders.GlideCircleWithBorder, PlayTube", "", this, new java.lang.Object[] {  });
	}
