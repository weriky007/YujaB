...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Helpers.Utils.Methods+AppLifecycleObserver, PlayTube", Methods_AppLifecycleObserver.class, __md_methods);
	}
	...
	public Methods_AppLifecycleObserver ()
	{
		...
		if (getClass () == Methods_AppLifecycleObserver.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Utils.Methods+AppLifecycleObserver, PlayTube", "", this, new java.lang.Object[] {  });
	}
