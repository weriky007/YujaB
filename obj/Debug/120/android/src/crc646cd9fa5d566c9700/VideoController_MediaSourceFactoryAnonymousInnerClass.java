...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Helpers.Controller.VideoController+MediaSourceFactoryAnonymousInnerClass, PlayTube", VideoController_MediaSourceFactoryAnonymousInnerClass.class, __md_methods);
	}
	...
	public VideoController_MediaSourceFactoryAnonymousInnerClass ()
	{
		...
		if (getClass () == VideoController_MediaSourceFactoryAnonymousInnerClass.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Controller.VideoController+MediaSourceFactoryAnonymousInnerClass, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public VideoController_MediaSourceFactoryAnonymousInnerClass (crc646cd9fa5d566c9700.VideoController p0)
	{
		super ();
		if (getClass () == VideoController_MediaSourceFactoryAnonymousInnerClass.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Controller.VideoController+MediaSourceFactoryAnonymousInnerClass, PlayTube", "PlayTube.Helpers.Controller.VideoController, PlayTube", this, new java.lang.Object[] { p0 });
	}
