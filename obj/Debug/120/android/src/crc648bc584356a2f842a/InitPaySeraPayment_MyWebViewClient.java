...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Payment.InitPaySeraPayment+MyWebViewClient, PlayTube", InitPaySeraPayment_MyWebViewClient.class, __md_methods);
	}
	...
	public InitPaySeraPayment_MyWebViewClient ()
	{
		...
		if (getClass () == InitPaySeraPayment_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("PlayTube.Payment.InitPaySeraPayment+MyWebViewClient, PlayTube", "", this, new java.lang.Object[] {  });
	}
