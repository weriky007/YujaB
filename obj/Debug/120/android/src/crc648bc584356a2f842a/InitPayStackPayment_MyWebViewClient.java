...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Payment.InitPayStackPayment+MyWebViewClient, PlayTube", InitPayStackPayment_MyWebViewClient.class, __md_methods);
	}
	...
	public InitPayStackPayment_MyWebViewClient ()
	{
		...
		if (getClass () == InitPayStackPayment_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("PlayTube.Payment.InitPayStackPayment+MyWebViewClient, PlayTube", "", this, new java.lang.Object[] {  });
	}
