...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Chat.Adapters.LastChatAdapter, PlayTube", LastChatAdapter.class, __md_methods);
	}
	...
	public LastChatAdapter ()
	{
		...
		if (getClass () == LastChatAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Chat.Adapters.LastChatAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}
	...
	public LastChatAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == LastChatAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Chat.Adapters.LastChatAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
