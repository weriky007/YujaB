...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Chat.Adapters.UserMessagesAdapter, PlayTube", UserMessagesAdapter.class, __md_methods);
	}
	...
	public UserMessagesAdapter ()
	{
		...
		if (getClass () == UserMessagesAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Chat.Adapters.UserMessagesAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public UserMessagesAdapter (crc64d85a9e76a49d401c.MessagesBoxActivity p0)
	{
		super ();
		if (getClass () == UserMessagesAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Chat.Adapters.UserMessagesAdapter, PlayTube", "PlayTube.Activities.Chat.MessagesBoxActivity, PlayTube", this, new java.lang.Object[] { p0 });
	}
