...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Live.Rtc.AgoraEventHandler, PlayTube", AgoraEventHandler.class, __md_methods);
	}
	...
	public AgoraEventHandler ()
	{
		...
		if (getClass () == AgoraEventHandler.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Live.Rtc.AgoraEventHandler, PlayTube", "", this, new java.lang.Object[] {  });
	}
