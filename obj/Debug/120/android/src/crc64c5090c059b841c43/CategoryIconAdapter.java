...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.CategoryIconAdapter, PlayTube", CategoryIconAdapter.class, __md_methods);
	}
	...
	public CategoryIconAdapter ()
	{
		...
		if (getClass () == CategoryIconAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.CategoryIconAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}
	...
	public CategoryIconAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == CategoryIconAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.CategoryIconAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
