...
public class WatchLaterVideoRowAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.WatchLaterVideoRowAdapter, PlayTube", WatchLaterVideoRowAdapter.class, __md_methods);
	}


	public WatchLaterVideoRowAdapter ()
	{
		super ();
		if (getClass () == WatchLaterVideoRowAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.WatchLaterVideoRowAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public WatchLaterVideoRowAdapter (android.app.Activity p0, java.lang.String p1)
	{
		super ();
		if (getClass () == WatchLaterVideoRowAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.WatchLaterVideoRowAdapter, PlayTube", "Android.App.Activity, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
