...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.VideoBigAdapter, PlayTube", VideoBigAdapter.class, __md_methods);
	}


	public VideoBigAdapter ()
	{
		super ();
		if (getClass () == VideoBigAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.VideoBigAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public VideoBigAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == VideoBigAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.VideoBigAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
