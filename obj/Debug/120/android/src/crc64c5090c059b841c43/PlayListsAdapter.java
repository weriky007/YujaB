...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.PlayListsAdapter, PlayTube", PlayListsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PlayListsAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.PlayListsAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public PlayListsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == PlayListsAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.PlayListsAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
