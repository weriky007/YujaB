...
public class AllChannelSubscribedAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.AllChannelSubscribedAdapter, PlayTube", AllChannelSubscribedAdapter.class, __md_methods);
	}


	public AllChannelSubscribedAdapter ()
	{
		super ();
		if (getClass () == AllChannelSubscribedAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.AllChannelSubscribedAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public AllChannelSubscribedAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == AllChannelSubscribedAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.AllChannelSubscribedAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
