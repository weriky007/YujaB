...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.ActivitiesAdapter, PlayTube", ActivitiesAdapter.class, __md_methods);
	}
	...
	public ActivitiesAdapter ()
	{
		...
		if (getClass () == ActivitiesAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.ActivitiesAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}
	...
	public ActivitiesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ActivitiesAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.ActivitiesAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
