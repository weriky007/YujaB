...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Article.CreateBlogActivity+MyWebChromeClient, PlayTube", CreateBlogActivity_MyWebChromeClient.class, __md_methods);
	}
	...
	public CreateBlogActivity_MyWebChromeClient ()
	{
		...
		if (getClass () == CreateBlogActivity_MyWebChromeClient.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Article.CreateBlogActivity+MyWebChromeClient, PlayTube", "", this, new java.lang.Object[] {  });
	}
	...
	public CreateBlogActivity_MyWebChromeClient (android.app.Activity p0)
	{
		super ();
		if (getClass () == CreateBlogActivity_MyWebChromeClient.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Article.CreateBlogActivity+MyWebChromeClient, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
