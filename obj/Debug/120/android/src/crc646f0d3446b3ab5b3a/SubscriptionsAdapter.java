...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Library.Adapters.SubscriptionsAdapter, PlayTube", SubscriptionsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SubscriptionsAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Library.Adapters.SubscriptionsAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public SubscriptionsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == SubscriptionsAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Library.Adapters.SubscriptionsAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
