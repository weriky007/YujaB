...
public class VideoImportActivity_MyWebViewClient
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Upload.VideoImportActivity+MyWebViewClient, PlayTube", VideoImportActivity_MyWebViewClient.class, __md_methods);
	}


	public VideoImportActivity_MyWebViewClient ()
	{
		super ();
		if (getClass () == VideoImportActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Upload.VideoImportActivity+MyWebViewClient, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public VideoImportActivity_MyWebViewClient (crc64ffdb8f543d833e1a.VideoImportActivity p0)
	{
		super ();
		if (getClass () == VideoImportActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Upload.VideoImportActivity+MyWebViewClient, PlayTube", "PlayTube.Activities.Upload.VideoImportActivity, PlayTube", this, new java.lang.Object[] { p0 });
	}
