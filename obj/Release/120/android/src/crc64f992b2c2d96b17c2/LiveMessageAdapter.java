...
public class LiveMessageAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Live.Adapters.LiveMessageAdapter, PlayTube", LiveMessageAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == LiveMessageAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Live.Adapters.LiveMessageAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public LiveMessageAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == LiveMessageAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Live.Adapters.LiveMessageAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
