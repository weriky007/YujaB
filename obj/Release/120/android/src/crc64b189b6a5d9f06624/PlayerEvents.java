...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.MediaPlayers.PlayerEvents, PlayTube", PlayerEvents.class, __md_methods);
	}
	...
	public PlayerEvents ()
	{
		...
		if (getClass () == PlayerEvents.class)
			mono.android.TypeManager.Activate ("PlayTube.MediaPlayers.PlayerEvents, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public PlayerEvents (crc646cd9fa5d566c9700.VideoController p0, android.app.Activity p1, com.google.android.exoplayer2.ui.PlayerControlView p2)
	{
		super ();
		if (getClass () == PlayerEvents.class)
			mono.android.TypeManager.Activate ("PlayTube.MediaPlayers.PlayerEvents, PlayTube", "PlayTube.Helpers.Controller.VideoController, PlayTube:Android.App.Activity, Mono.Android:Com.Google.Android.Exoplayer2.UI.PlayerControlView, ExoPlayer.UI", this, new java.lang.Object[] { p0, p1, p2 });
	}
