...
public class VideoUploadActivity_MyWebViewClient
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Upload.VideoUploadActivity+MyWebViewClient, PlayTube", VideoUploadActivity_MyWebViewClient.class, __md_methods);
	}


	public VideoUploadActivity_MyWebViewClient ()
	{
		super ();
		if (getClass () == VideoUploadActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Upload.VideoUploadActivity+MyWebViewClient, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public VideoUploadActivity_MyWebViewClient (crc64ffdb8f543d833e1a.VideoUploadActivity p0)
	{
		super ();
		if (getClass () == VideoUploadActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Upload.VideoUploadActivity+MyWebViewClient, PlayTube", "PlayTube.Activities.Upload.VideoUploadActivity, PlayTube", this, new java.lang.Object[] { p0 });
	}
