...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Tabbes.Adapters.TrendingAdapter, PlayTube", TrendingAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == TrendingAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Tabbes.Adapters.TrendingAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public TrendingAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == TrendingAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Tabbes.Adapters.TrendingAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
