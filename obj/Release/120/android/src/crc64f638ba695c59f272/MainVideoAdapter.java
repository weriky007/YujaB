...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Tabbes.Adapters.MainVideoAdapter, PlayTube", MainVideoAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == MainVideoAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Tabbes.Adapters.MainVideoAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public MainVideoAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == MainVideoAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Tabbes.Adapters.MainVideoAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
