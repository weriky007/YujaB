...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Helpers.Utils.RecyclerViewOnScrollListener, PlayTube", RecyclerViewOnScrollListener.class, __md_methods);
	}
	...
	public RecyclerViewOnScrollListener ()
	{
		...
		if (getClass () == RecyclerViewOnScrollListener.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Utils.RecyclerViewOnScrollListener, PlayTube", "", this, new java.lang.Object[] {  });
	}
