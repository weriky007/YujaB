...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Helpers.Ads.AdsGoogle+InitializeAdsGoogle+MyInitializationCompleteListener, PlayTube", AdsGoogle_InitializeAdsGoogle_MyInitializationCompleteListener.class, __md_methods);
	}
	...
	public AdsGoogle_InitializeAdsGoogle_MyInitializationCompleteListener ()
	{
		...
		if (getClass () == AdsGoogle_InitializeAdsGoogle_MyInitializationCompleteListener.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Ads.AdsGoogle+InitializeAdsGoogle+MyInitializationCompleteListener, PlayTube", "", this, new java.lang.Object[] {  });
	}
