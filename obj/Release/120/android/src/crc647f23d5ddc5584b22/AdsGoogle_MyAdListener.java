...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Helpers.Ads.AdsGoogle+MyAdListener, PlayTube", AdsGoogle_MyAdListener.class, __md_methods);
	}
	...
	public AdsGoogle_MyAdListener ()
	{
		...
		if (getClass () == AdsGoogle_MyAdListener.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Ads.AdsGoogle+MyAdListener, PlayTube", "", this, new java.lang.Object[] {  });
	}
	...
	public AdsGoogle_MyAdListener (com.google.android.gms.ads.AdView p0, androidx.recyclerview.widget.RecyclerView p1)
	{
		super ();
		if (getClass () == AdsGoogle_MyAdListener.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Ads.AdsGoogle+MyAdListener, PlayTube", "Android.Gms.Ads.AdView, Xamarin.GooglePlayServices.Ads.Lite:AndroidX.RecyclerView.Widget.RecyclerView, Xamarin.AndroidX.RecyclerView", this, new java.lang.Object[] { p0, p1 });
	}
