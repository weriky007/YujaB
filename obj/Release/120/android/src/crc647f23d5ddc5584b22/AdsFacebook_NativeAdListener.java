...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Helpers.Ads.AdsFacebook+NativeAdListener, PlayTube", AdsFacebook_NativeAdListener.class, __md_methods);
	}
	...
	public AdsFacebook_NativeAdListener ()
	{
		...
		if (getClass () == AdsFacebook_NativeAdListener.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Ads.AdsFacebook+NativeAdListener, PlayTube", "", this, new java.lang.Object[] {  });
	}
	...
	public AdsFacebook_NativeAdListener (android.app.Activity p0, com.facebook.ads.NativeAd p1, android.widget.LinearLayout p2)
	{
		super ();
		if (getClass () == AdsFacebook_NativeAdListener.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Ads.AdsFacebook+NativeAdListener, PlayTube", "Android.App.Activity, Mono.Android:Xamarin.Facebook.Ads.NativeAd, Xamarin.Facebook.AudienceNetwork.Android:Android.Widget.LinearLayout, Mono.Android", this, new java.lang.Object[] { p0, p1, p2 });
	}
