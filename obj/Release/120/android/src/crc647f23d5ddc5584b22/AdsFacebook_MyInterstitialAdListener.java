...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Helpers.Ads.AdsFacebook+MyInterstitialAdListener, PlayTube", AdsFacebook_MyInterstitialAdListener.class, __md_methods);
	}
	...
	public AdsFacebook_MyInterstitialAdListener ()
	{
		...
		if (getClass () == AdsFacebook_MyInterstitialAdListener.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Ads.AdsFacebook+MyInterstitialAdListener, PlayTube", "", this, new java.lang.Object[] {  });
	}
	...
	public AdsFacebook_MyInterstitialAdListener (android.app.Activity p0, com.facebook.ads.InterstitialAd p1)
	{
		super ();
		if (getClass () == AdsFacebook_MyInterstitialAdListener.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.Ads.AdsFacebook+MyInterstitialAdListener, PlayTube", "Android.App.Activity, Mono.Android:Xamarin.Facebook.Ads.InterstitialAd, Xamarin.Facebook.AudienceNetwork.Android", this, new java.lang.Object[] { p0, p1 });
	}
