...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.MoviesAdapter, PlayTube", MoviesAdapter.class, __md_methods);
	}
	...
	public MoviesAdapter ()
	{
		...
		if (getClass () == MoviesAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.MoviesAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public MoviesAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == MoviesAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.MoviesAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
