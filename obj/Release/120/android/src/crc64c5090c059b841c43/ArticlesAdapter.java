...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.ArticlesAdapter, PlayTube", ArticlesAdapter.class, __md_methods);
	}
	...
	public ArticlesAdapter ()
	{
		...
		if (getClass () == ArticlesAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.ArticlesAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public ArticlesAdapter (android.app.Activity p0, crc64368c0336411f3a42.ArticlesFragment p1)
	{
		super ();
		if (getClass () == ArticlesAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.ArticlesAdapter, PlayTube", "Android.App.Activity, Mono.Android:PlayTube.Activities.Article.ArticlesFragment, PlayTube", this, new java.lang.Object[] { p0, p1 });
	}
