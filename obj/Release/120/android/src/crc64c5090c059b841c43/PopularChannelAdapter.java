...
public class PopularChannelAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.PopularChannelAdapter, PlayTube", PopularChannelAdapter.class, __md_methods);
	}


	public PopularChannelAdapter ()
	{
		super ();
		if (getClass () == PopularChannelAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.PopularChannelAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public PopularChannelAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == PopularChannelAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.PopularChannelAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
