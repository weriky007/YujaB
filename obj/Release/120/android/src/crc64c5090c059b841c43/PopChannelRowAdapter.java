...
public class PopChannelRowAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.PopChannelRowAdapter, PlayTube", PopChannelRowAdapter.class, __md_methods);
	}


	public PopChannelRowAdapter ()
	{
		super ();
		if (getClass () == PopChannelRowAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.PopChannelRowAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public PopChannelRowAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == PopChannelRowAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.PopChannelRowAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
