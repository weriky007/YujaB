...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.VideoRowAdapter, PlayTube", VideoRowAdapter.class, __md_methods);
	}


	public VideoRowAdapter ()
	{
		super ();
		if (getClass () == VideoRowAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.VideoRowAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public VideoRowAdapter (android.app.Activity p0, java.lang.String p1)
	{
		super ();
		if (getClass () == VideoRowAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.VideoRowAdapter, PlayTube", "Android.App.Activity, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
