...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Adapters.LibraryAdapter, PlayTube", LibraryAdapter.class, __md_methods);
	}
	...
	public LibraryAdapter ()
	{
		...
		if (getClass () == LibraryAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.LibraryAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public LibraryAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == LibraryAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Adapters.LibraryAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
