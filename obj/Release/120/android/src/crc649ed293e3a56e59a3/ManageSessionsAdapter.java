...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.SettingsPreferences.Adapters.ManageSessionsAdapter, PlayTube", ManageSessionsAdapter.class, __md_methods);
	}
	...
	public ManageSessionsAdapter ()
	{
		...
		if (getClass () == ManageSessionsAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.SettingsPreferences.Adapters.ManageSessionsAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}
	...
	public ManageSessionsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ManageSessionsAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.SettingsPreferences.Adapters.ManageSessionsAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
