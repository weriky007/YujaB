...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Library.Adapters.VideoPlaylistAdapter, PlayTube", VideoPlaylistAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == VideoPlaylistAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Library.Adapters.VideoPlaylistAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public VideoPlaylistAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == VideoPlaylistAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Library.Adapters.VideoPlaylistAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
