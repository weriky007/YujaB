...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Comments.Adapters.CommentsAdapter, PlayTube", CommentsAdapter.class, __md_methods);
	}
	...
	public CommentsAdapter ()
	{
		...
		if (getClass () == CommentsAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Comments.Adapters.CommentsAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}
	...
	public CommentsAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == CommentsAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Comments.Adapters.CommentsAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
