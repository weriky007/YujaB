...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Comments.Adapters.ReplyAdapter, PlayTube", ReplyAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ReplyAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Comments.Adapters.ReplyAdapter, PlayTube", "", this, new java.lang.Object[] {  });
	}

	public ReplyAdapter (android.app.Activity p0)
	{
		super ();
		if (getClass () == ReplyAdapter.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Comments.Adapters.ReplyAdapter, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
