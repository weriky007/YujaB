...
public class ReplyCommentBottomSheet_MyBottomSheetCallBack
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.Comments.ReplyCommentBottomSheet+MyBottomSheetCallBack, PlayTube", ReplyCommentBottomSheet_MyBottomSheetCallBack.class, __md_methods);
	}


	public ReplyCommentBottomSheet_MyBottomSheetCallBack ()
	{
		super ();
		if (getClass () == ReplyCommentBottomSheet_MyBottomSheetCallBack.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.Comments.ReplyCommentBottomSheet+MyBottomSheetCallBack, PlayTube", "", this, new java.lang.Object[] {  });
	}
