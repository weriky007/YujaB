...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Library.OneSignalNotif.OneSignalNotification, PlayTube", OneSignalNotification.class, __md_methods);
	}
	...
	public OneSignalNotification ()
	{
		...
		if (getClass () == OneSignalNotification.class)
			mono.android.TypeManager.Activate ("PlayTube.Library.OneSignalNotif.OneSignalNotification, PlayTube", "", this, new java.lang.Object[] {  });
	}
