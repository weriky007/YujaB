...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Activities.LocalWebViewActivity+MyWebViewClient, PlayTube", LocalWebViewActivity_MyWebViewClient.class, __md_methods);
	}
	...
	public LocalWebViewActivity_MyWebViewClient ()
	{
		...
		if (getClass () == LocalWebViewActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.LocalWebViewActivity+MyWebViewClient, PlayTube", "", this, new java.lang.Object[] {  });
	}
	...
	public LocalWebViewActivity_MyWebViewClient (android.app.Activity p0)
	{
		super ();
		if (getClass () == LocalWebViewActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("PlayTube.Activities.LocalWebViewActivity+MyWebViewClient, PlayTube", "Android.App.Activity, Mono.Android", this, new java.lang.Object[] { p0 });
	}
