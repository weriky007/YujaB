...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Helpers.CacheLoaders.ImageCoursalViewPager, PlayTube", ImageCoursalViewPager.class, __md_methods);
	}
	...
	public ImageCoursalViewPager ()
	{
		...
		if (getClass () == ImageCoursalViewPager.class)
			mono.android.TypeManager.Activate ("PlayTube.Helpers.CacheLoaders.ImageCoursalViewPager, PlayTube", "", this, new java.lang.Object[] {  });
	}
