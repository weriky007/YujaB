...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PlayTube.Library.Anjo.SuperTextLibrary.StReadMoreOption+StRclickableSpan, PlayTube", StReadMoreOption_StRclickableSpan.class, __md_methods);
	}
	...
	public StReadMoreOption_StRclickableSpan ()
	{
		...
		if (getClass () == StReadMoreOption_StRclickableSpan.class)
			mono.android.TypeManager.Activate ("PlayTube.Library.Anjo.SuperTextLibrary.StReadMoreOption+StRclickableSpan, PlayTube", "", this, new java.lang.Object[] {  });
	}
