...
namespace PlayTube.Helpers.Ads
{
    public static class AdsGoogle
    {
        ...
        public static void Ad_Interstitial(Activity context)
        {
            try
            {
                switch (AppTools.GetStatusAds() && AppSettings.ShowAdMobInterstitial)
                {
                    case true:
                        {
            ...
            public void ShowAd(Activity context, TemplateView template = null)
            {
                try
                {
                    ...
                    if (Template != null)
                    {
                        ...
                        switch (AppTools.GetStatusAds() && AppSettings.ShowAdMobNative)
                        {
                            case true:
                                {
        ...
        public static AdMobRewardedVideo Ad_RewardedVideo(Activity context)
        {
            try
            {
                switch (AppTools.GetStatusAds() && AppSettings.ShowAdMobRewardVideo)
                {
        ...
        public static void InitAdView(AdView mAdView, RecyclerView mRecycler)
        {
            try
            {
                ...
                switch (AppTools.GetStatusAds() && AppSettings.ShowAdMobBanner)
                {
                    case true:
                        {
        ...
        public static void Ad_AppOpenManager(Activity context)
        {
            try
            {
                switch (AppTools.GetStatusAds() && AppSettings.ShowAdMobAppOpen)
                {
                    case true:
                        {
        ...
        public static AdMobRewardedInterstitial Ad_RewardedInterstitial(Activity context)
        {
            try
            {
                switch (AppTools.GetStatusAds() && AppSettings.ShowAdMobRewardedInterstitial)
                {
        ...
        public static class InitializeAdsGoogle
        {
            public static void Initialize(Context context)
            {
                try
                {
                    if (AppTools.GetStatusAds() && (AppSettings.ShowAdMobBanner || AppSettings.ShowAdMobInterstitial || AppSettings.ShowAdMobRewardVideo || AppSettings.ShowAdMobNative || AppSettings.ShowAdMobAppOpen || AppSettings.ShowAdMobRewardedInterstitial))
                    {
